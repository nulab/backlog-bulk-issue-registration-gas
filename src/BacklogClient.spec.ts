...
describe("BacklogClient", function () {
  ...
  test("Get custom field definitions", function () {
    ...
    expect(CustomFieldDefinitions[0].useIssueType).toBe(false)
    ...
    expect(CustomFieldDefinitions[1].useIssueType).toBe(false)
    ...
    expect(CustomFieldDefinitions[2].useIssueType).toBe(false)
