...
![](https://github.com/nulab/backlog-bulk-issue-registration-gas/wiki/images/ja/parent_issue.png)

### カスタム属性
プロジェクトにカスタム属性が登録されている場合、後述するSTEP1を実行することでカスタム属性が水色のカラムとして追加されます。

* 複数選択可能なカスタム属性は追加されません。
* ラジオボタン形式のカスタム属性は追加されません。
...
<img src="https://github.com/nulab/backlog-bulk-issue-registration-gas/wiki/images/ja/form_step1_2.1.0.png" width="453" height="272">
...
<img src="https://github.com/nulab/backlog-bulk-issue-registration-gas/wiki/images/ja/form_step2_2.1.0.png" width="455" height="271">
...
カスタム属性の設定は自動的に反映されません。カスタム属性の名前やカスタム属性の形式が変更された場合は、カスタム属性の列を **すべて** 削除し、再度STEP1の操作から実行してください。
